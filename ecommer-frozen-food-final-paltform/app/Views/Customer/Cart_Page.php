            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        ...
                        <!-- Gambar Produk -->
                        <img src="<?= base_url($item['path']) ?>" alt="<?= $item['product_name'] ?>" class="rounded me-3" style="width: 80px; height: 80px; object-fit: cover;">
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="<?= base_url('cart/delete/' . $item['cart_id']) ?>" class="position-absolute end-0 top-0 m-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="green" class="bi bi-trash3" viewBox="0 0 16 16">
                                        ...
                                        1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1
                                        -.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 
                            ...
                            <div>
                                <p class="fw-bold text-danger me-3 subtotal-text" id="subtotal-<?= esc($item['cart_id']) ?>">
                            ...
                            <div class="input-group" style="width: 120px;">
                                ...
                                <input type="number" class="form-control text-center qty-input" name="quantity[<?= esc($item['cart_id']) ?>]" 
                                min="1" value="<?= $item['quantity'] ?>" data-price="<?= $item['price'] ?>">
